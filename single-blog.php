...
<head>
  ...
  <title>新入社員向けに、入社前研修を行いました。 | 株式会社TETOTE</title>
...
<body class="exp-grid p-singleBlog" id="single-blog">
      ...
      <div class="c-breadcrumbs">
        <div class="l-inner--lower p-breadcrumbs__inner">
          <ol class="c-breadcrumbs__list">
            ...
            <li><a href="/blog/新入社員向けに、入社前研修を行いました。"></a>新入社員向けに、入社前研修を行いました。</li>
          </ol>
        </div>
      </div>
      ...
      <div class="l-inner--800 p-singleBlog__inner">
        <div class="p-singleBlog__contents">
          <div class="p-singleBlog__head">
            <p class="p-singleBlog__category">社内研修</p>
            <p class="p-singleBlog__date">2025.03.25</p>
          </div>
          <h1 class="p-singleBlog__title">新入社員向けに、入社前研修を行いました。</h1>
          <img class="p-singleBlog__img" src="<?php echo esc_url(get_theme_file_uri()); ?>/img/img_blog1.jpg" alt="研修会場で話す女性講師">
          ...
          <h2>今後の期待</h2>
          <p>今回の研修で学んだことを活かして、新入社員の皆さんが、一人前の社会人として成長していくことを期待しています。<br>
